...
/**
 * The translate course translated event.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class course_translated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcoursetranslated', 'tool_translate');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' translated the elements of the course with id $this->courseid.";
    }
